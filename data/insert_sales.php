...
try {
    ...
    include_once __DIR__ . '/../data/Database.php'; // Ruta correcta a Database.php
    include_once __DIR__ . '/../business/SalesReportFacade.php'; // Ruta correcta a SalesReportFacade.php
